...
public class Language {
    ...
    public static Map<String, Color> defaults() {
        ...
        keywordColorMap.put("continue", Color.GREEN);
        keywordColorMap.put("finally", DARK_RED);
        keywordColorMap.put("import", LIGHT_RED);
        keywordColorMap.put("return", Color.GREEN);
        keywordColorMap.put("try", LIGHT_RED);
        keywordColorMap.put("if", Color.RED);
        keywordColorMap.put("else", Color.RED);
        keywordColorMap.put("while", Color.ORANGE);
        keywordColorMap.put("for", Color.ORANGE);
